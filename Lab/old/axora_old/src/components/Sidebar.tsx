...
export function Sidebar() {
    ...
    const hiddenLinks = [
        { to: '/thesis', icon: GraduationCap, label: 'Thèse & Recherche' },
        { to: '/settings', icon: Settings, label: 'Paramètres' },
    ];

    return (
        <div className="w-64 h-screen bg-[#1a1c2e]/90 border-r border-[#2d323b] flex flex-col backdrop-blur-xl relative">
